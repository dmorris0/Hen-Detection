...
It also comes with the `.yaml` file of which the model runs from, but I have yet to understand where I can use that in a way that doesn't fail on me. (PENDING TEST)
