...
TEMPORARY NOTE: if neither method seem to work as I had iniitally considered, I will write my own program built on parts of the code provided through the Colab learning experience, and code I write up to make it easier to run or use.
